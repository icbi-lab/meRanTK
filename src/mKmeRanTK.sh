...
/usr/local/bioinf/perl/perl-5.24.3/bin/pp -B -M Data::Dumper -M diagnostics -M GD -M GD::Text -M GD::Text::Align -M GD::Graph::lines -l /usr/lib64/libgd.so.2 -c -vv -o meRanGt meRanGt.pl
